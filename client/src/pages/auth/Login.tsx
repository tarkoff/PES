      ...
      >
        <div className="glass-panel p-8 border-white/20">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-white mb-2">Вхід в систему</h1>
            <p className="text-gray-400">Введіть свої дані для входу</p>
          </div>
          ...
          <div className="my-6 flex items-center">
            ...
            <span className="px-4 text-sm text-gray-400">або увійти через</span>
            <div className="flex-1 border-t border-white/10"></div>
          </div>
          ...
          <p className="text-center mt-6 text-gray-400">
            ...
            <Link to="/register" className="text-primary-400 hover:text-primary-500 font-semibold transition-colors duration-200">
              Зареєструватися
            </Link>
          </p>
        </div>
